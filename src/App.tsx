  ...
  return (
    <>
      ...
      <div className="hidden md:flex min-h-screen bg-neutral-200">
        ...
        {/* Main content */}
        <main className="ml-64 flex-1 flex items-start justify-center py-8 px-8 lg:px-12 xl:px-16 min-h-screen">
          <div className="w-full max-w-2xl lg:max-w-4xl xl:max-w-6xl">
            {/* PC top bar */}
            <div className="md:hidden flex items-center justify-between mb-6">
              <div>
